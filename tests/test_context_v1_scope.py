...
from runtime.action_projection import ActionProjectionError, _SUPPORTED_PROJECTION_ACTIONS, build_action_projection
...
class ActionProjectionTests(unittest.TestCase):
    ...
    def test_archive_review_no_longer_supported_as_projection_action(self) -> None:
        """archive_review was removed in Wave 2b — archive uses continue_host_consult."""
        self.assertNotIn("archive_review", _SUPPORTED_PROJECTION_ACTIONS)
